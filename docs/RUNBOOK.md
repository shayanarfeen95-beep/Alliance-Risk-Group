...
| `N accounts carrying a balance … are not in the chart of accounts` | Deleted QuickBooks accounts still hold historical balances | Pull **Chart of Accounts**, then the balance sheet again. The accounts pull now includes inactive accounts for exactly this reason; before it did not, and deleted accounts blocked every month they appeared in. |
